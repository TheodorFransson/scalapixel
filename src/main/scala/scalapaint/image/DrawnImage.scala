...
import scalapaint.*
import gui.CanvasPanelDeprecated
...
class DrawnImage(width: Int, height: Int, canvas: CanvasPanelDeprecated) extends BufferedImage(width, height, BufferedImage.TYPE_INT_ARGB):
    import DrawnImage.*
